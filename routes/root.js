...
async function drawTable(rq)  {
  ...
  let card0; if (!rq.c0) {card0 = dummy_card;} else {card0 = rq.c0;}
  let card1; if (!rq.c1) {card1 = dummy_card;} else {card1 = rq.c1;}
  let card2; if (!rq.c2) {card2 = dummy_card;} else {card2 = rq.c2;}
  let card3; if (!rq.c3) {card3 = dummy_card;} else {card3 = rq.c3;}
  let card4; if (!rq.c4) {card4 = dummy_card;} else {card4 = rq.c4;}
  let card5; if (!rq.c5) {card5 = dummy_card;} else {card5 = rq.c5;}
  let card6; if (!rq.c6) {card6 = dummy_card;} else {card6 = rq.c6;}
  let card7; if (!rq.c7) {card7 = dummy_card;} else {card7 = rq.c7;}
  let card8; if (!rq.c8) {card8 = dummy_card;} else {card8 = rq.c8;}
  let card9; if (!rq.c9) {card9 = dummy_card;} else {card9 = rq.c9;}
  ...
  const lin1 = padding;
  const lin2 = lin1 + padding + card_hight;
  const lin3 = lin2 + padding + card_hight;
  const col1 = padding;
  const col2 = col1 + padding + card_width;
  const col3 = col2 + padding + card_width;
  const col4 = col3 + padding + card_width;
  const col5 = col4 + padding + card_width;
  let canvas_w;
  let canvas_h;
  let c0col;
  let c0lin;
  ...
  let c9lin;
  if (col === 5) {
    canvas_w = (card_width*5) + (padding*6);
    canvas_h = (card_hight*2) + (padding*3);
    c0col = col1;
    c0lin = lin1
    c1col = col2;
    c1lin = lin1;
    ...
    canvas_w = (card_width*4) + (padding*5);
    canvas_h = (card_hight*3) + (padding*4);
    c0col = col1;
    c0lin = lin1;
    c1col = col2;
    c1lin = lin1;
